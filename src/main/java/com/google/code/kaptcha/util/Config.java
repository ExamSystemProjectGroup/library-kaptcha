...
public class Config {
    ...
    public TextProducer getTextProducerImpl() {
        ...
        String paramValue = this.properties.getProperty(paramName);
        return (TextProducer) this.helper.getClassInstance(paramName, paramValue, new DefaultTextCreator(), this);
    }
    ...
    public NoiseProducer getNoiseImpl() {
        ...
        String paramValue = this.properties.getProperty(paramName);
        return (NoiseProducer) this.helper.getClassInstance(paramName, paramValue, new DefaultNoise(), this);
    }
    ...
    public WordRenderer getWordRendererImpl() {
        ...
        String paramValue = this.properties.getProperty(paramName);
        return (WordRenderer) this.helper.getClassInstance(paramName, paramValue, new DefaultWordRenderer(), this);
    }

    public BackgroundProducer getBackgroundImpl() {
        String paramName = Constants.KAPTCHA_BACKGROUND_IMPL;
        String paramValue = this.properties.getProperty(paramName);
        return (BackgroundProducer) this.helper.getClassInstance(paramName, paramValue, new DefaultBackground(), this);
    }
